...
COMPONENT.Title = [[Ford 96T LRPD Rear Spoiler Light]]
...
COMPONENT.StateMap = "[1] 1 3 [2] 5 6 7 8 9 10 [3] 2 4 "
...
COMPONENT.Segments = {
	...
	["DVI"] = {
		Frames = {
			[0] = "[~R*0.5] 1 3 [~B*0.5] 5 6 7 8 9 10 [~A*0.5] 2 4",
			[1] = "1:~R 2:~A",
			[2] = "3:~R 4:~A",
			[3] = "5:~B 6:~B",
			[4] = "7:~B 8:~B",
		...
		Sequences = {
			["ON"] = sequence():Sequential(1, 5):Stretch(8)
		}
	},
	["Traffic"] = {
		Frames = {
