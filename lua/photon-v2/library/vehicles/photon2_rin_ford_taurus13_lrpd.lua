...
VEHICLE.Title 		= "2013 Ford Taurus LRPD"
		...
		Options = {
			{
				Option = "Patrol",
				SubMaterials = {
					{ Id = 27, Material = "rin/lrpd2/taurus/patrol" }
				}
			},
			{
				Option = "Supervisor",
				SubMaterials = {
					{ Id = 27, Material = "rin/lrpd2/taurus/supervisor" }
				}
			}
		}
	},
			    ...
			    Props = {
					{
						...
						Position = Vector( 31, -100, 54.9),
						Angles = Angle( -2, 235, -3.5 ),
						Scale = 1,
						SubMaterials = {
