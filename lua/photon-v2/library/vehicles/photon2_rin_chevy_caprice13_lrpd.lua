...
VEHICLE.Title 		= "2013 Chevrolet Caprice LRPD"
...
VEHICLE.Equipment = {
	{
		...
		Options = {
			
			{
				Option = "Patrol",
				SubMaterials = {
					{ Id = 13, Material = "rin/lrpd2/caprice13/patrol" }
				},
				BodyGroups = {
			...
			{
				Option = "K-9 Unit Chica",
				SubMaterials = {
					{ Id = 13, Material = "rin/lrpd2/caprice13/k9" },
				},
				BodyGroups = {
			...
			},
			{
				...
				SubMaterials = {
					{ Id = 13, Material = "rin/lrpd2/caprice13/traffic" }
				},
				BodyGroups = {
					{ BodyGroup = "model", Value = 0 },
				},
			...
			},
			{
				Option = "Supervisor",
				SubMaterials = {
					{ Id = 13, Material = "rin/lrpd2/caprice13/supervisor" }
				},
				BodyGroups = {
					{ BodyGroup = "model", Value = 0 },
				},
			...
			{
				Option = "Breast Cancer Awareness",
				SubMaterials = {
					{ Id = 13, Material = "rin/lrpd2/caprice13/pink" }
				},
				BodyGroups = {
					{ BodyGroup = "model", Value = 0 },
				},
