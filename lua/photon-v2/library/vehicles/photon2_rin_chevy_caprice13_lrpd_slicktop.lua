...
VEHICLE.Title 		= "2013 Chevrolet Caprice LRPD Slicktop"
...
VEHICLE.Equipment = {
	{
		...
		Options = {
			
			{
				Option = "Patrol",
				SubMaterials = {
					{ Id = 13, Material = "rin/lrpd2/caprice13/patrol_slick" }
				},
				BodyGroups = {
			...
			},
			{
				...
				SubMaterials = {
					{ Id = 13, Material = "rin/lrpd2/caprice13/traffic_slick" }
				},
				BodyGroups = {
					{ BodyGroup = "model", Value = 0 },
				},
